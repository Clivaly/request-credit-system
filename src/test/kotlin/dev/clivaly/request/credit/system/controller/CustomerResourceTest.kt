...
class CustomerResourceTest {
    ...
    fun `should create a customer and return 201 status`() {
        //given
        val customerDto: dev.clivaly.request.credit.system.dto.CustomerDto = builderCustomerDto()
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(URL).contentType(MediaType.APPLICATION_JSON).content(valueAsString))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("jhon@jhon.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("000000"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua do Jhon, 123"))
    ...
    fun `should not save a customer with empty firstName and return 400 status`() {
        //given
        val customerDto: dev.clivaly.request.credit.system.dto.CustomerDto = builderCustomerDto(firstName = "")
        val valueAsString: String = objectMapper.writeValueAsString(customerDto)
        //when
        //then
        mockMvc.perform(
    ...
    fun `should find customer by id and return 200 status`() {
        //given
        val customer: dev.clivaly.request.credit.system.entity.Customer = customerRepository.save(builderCustomerDto().toEntity())
        //when
        //then
        mockMvc.perform(
    ...
    fun `should update a customer and return 200 status`() {
        //given
        val customer: dev.clivaly.request.credit.system.entity.Customer = customerRepository.save(builderCustomerDto().toEntity())
        val customerUpdateDto: dev.clivaly.request.credit.system.dto.CustomerUpdateDto = builderCustomerUpdateDto()
    ...
    private fun builderCustomerDto(
        ...
        street: String = "Rua do Jhon, 123",
    ) = dev.clivaly.request.credit.system.dto.CustomerDto(
        firstName = firstName,
        lastName = lastName,
        cpf = cpf,
        email = email,
    ...
    private fun builderCustomerUpdateDto(
        ...
        lastName: String = "DonUpdate",
        income: BigDecimal = BigDecimal.valueOf(5000.0),
        zipCode: String = "45656",
        street: String = "Rua Updated"
    ): dev.clivaly.request.credit.system.dto.CustomerUpdateDto =
        dev.clivaly.request.credit.system.dto.CustomerUpdateDto(
            firstName = firstName,
            lastName = lastName,
            income = income,
